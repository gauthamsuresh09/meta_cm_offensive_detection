...
if val_set:
  ...
  train_texts, val_texts, train_labels, val_labels = train_test_split(train_texts, train_labels, random_state=42, test_size=0.15)

# Few shot training
train_size = 0.25
train_texts, _, train_labels, _ = train_test_split(train_texts, train_labels, random_state=42, train_size=train_size)
...
saved_models_filepath = "/home/azureuser/meta/ml_code/offensive_lang_detect_binary/saved_models/"
